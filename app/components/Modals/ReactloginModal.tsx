    ...
    return (
        <>
            ...
            <Modal 
                ...
                <Modal.Body className='modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable'>
                        ...
                        <div className="row align-items-center g-4">
                            ...
                            <div className="col-lg-6">
                                ...
                                <ul className="nav nav-tabs" id="myTab2" role="tablist">
                                        ...
                                        <li className="nav-item" role="presentation">
                                            <button className={`nav-link ${activetab === 'login' ? 'active' : ''}`} onClick={() => handleTabClick('signup')}  id="contact-tab3" data-bs-toggle="tab" data-bs-target="#contact2"
                                            ...
                                            <div className="form__tabs__wrap">
                                                ...
                                                <form action="#0">
                                                    <div className="form__grp">
                                                        ...
                                                        <input  type="email" id="emailsign" placeholder="Your Email "  />
                                                    </div>
...
export default ReactLoginModal;