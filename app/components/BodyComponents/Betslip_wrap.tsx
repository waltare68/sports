...
export default function Betslip_wrap({ IsLoggedIn, UserEmail }: BetslipProps) {
    ...
    //const [selectedvirtualEvents, setSelectedVirtualEvents] = useState<SelectedEvent[]>([]);
    ...
    useEffect(() => {
        ...
        const handleStorageChange = () => {
            ...
            console.log(eventsvirtualArray)
    ...
    // console.log("change");
    // console.log(selectedvirtualEvents);
    return (
        <>
