"use client"
import Footer_small_menu from '@/app/dashboard/components/Footer_small_menu';
...
export default function Main_body_wrapper({ children, isLoggedIn,userEmail }: MainAreaProps) {
