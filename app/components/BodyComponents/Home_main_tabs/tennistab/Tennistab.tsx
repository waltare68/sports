...
const Tennistab = ({ selectedTab }: Taboneprops) => {
    const className = selectedTab === 'tennis' ? 'tab-pane text-white fade show active' : 'tab-pane text-white fade';
  return (
    <>
      <div className={className} id="mainTab" role="tabpanel">
                ...
                <div className="main__body__wrap left__right__space">
                    ...
                    <span className="empty__message">
                        Tennis data is not yet available, please come back later.</span> 
                    </div>
